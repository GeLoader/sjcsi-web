<?php
// Dynamic DEPARTMENTcba.php - Pulls content from database
$page_title = 'CBA Department';
...
<section class="hero-section position-relative text-white">
    ...
    $bg_image = getSectionImage($sections, 'hero_title') ?: ($hero_meta['bg_image'] ?? 'images/cba-cover.jpg');
            ...
            <div class="col-lg-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        $chairperson_query = dbPrepare("SELECT * FROM cba_faculty WHERE is_chairperson = 1 AND is_active = 1 LIMIT 1");
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="contact-form" method="POST">
                    <input type="hidden" name="department" value="CBA">
                    <div class="row">
                        <div class="col-md-6">
