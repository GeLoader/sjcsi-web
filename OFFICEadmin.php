<?php
// Dynamic DEPARTMENTADMIN.php - Pulls content from database
$page_title = 'ADMIN OFFICE';
...
<section class="hero-section position-relative text-white">
    ...
    $bg_image = getSectionImage($sections, 'hero_title') ?: ($hero_meta['bg_image'] ?? 'images/ADMIN-cover.jpg');
            ...
            <div class="col-lg-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        $chairperson_query = dbPrepare("SELECT * FROM ADMIN_faculty WHERE is_chairperson = 1 AND is_active = 1 LIMIT 1");
