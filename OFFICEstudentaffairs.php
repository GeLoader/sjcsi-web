<?php
// Dynamic DEPARTMENTSTUDENT_AFFAIRS.php - Pulls content from database
$page_title = 'STUDENT_AFFAIRS OFFICE';
...
<section class="hero-section position-relative text-white">
    ...
    $bg_image = getSectionImage($sections, 'hero_title') ?: ($hero_meta['bg_image'] ?? 'images/STUDENT_AFFAIRS-cover.jpg');
            ...
            <div class="col-lg-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        $chairperson_query = dbPrepare("SELECT * FROM STUDENT_AFFAIRS_faculty WHERE is_chairperson = 1 AND is_active = 1 LIMIT 1");
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="contact-form" method="POST">
                    <input type="hidden" name="department" value="STUDENTAFFAIRS">
                    <div class="row">
                        <div class="col-md-6">
