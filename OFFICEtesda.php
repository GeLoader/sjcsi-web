<?php
// Dynamic DEPARTMENTTESDA.php - Pulls content from database
$page_title = 'TESDA OFFICE';
...
<section class="hero-section position-relative text-white">
    ...
    $bg_image = getSectionImage($sections, 'hero_title') ?: ($hero_meta['bg_image'] ?? 'images/TESDA-cover.jpg');
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4 p-3 bg-light rounded">
                            <h3 class="h5 text-primary">INNOVATION AND TECHNOLOGY</h3>
                            <h4 class="h6 text-success">PROGRAM SPECIALIZATION</h4>
                            <h4 class="h6 text-info">INDUSTRY-READY SKILLS</h4>
                        </div>
                    </div>
                </div>
...
<div class="card mb-4">
    <div class="card-header bg-white">
        <h2 class="card-title h4 mb-0"><?= getSectionTitle($sections, 'programs_offered') ?></h2>
    </div>
    <div class="card-body">
        <?php if ($content = getSection($sections, 'programs_offered')): ?>
        <div class="mb-4">
            <?= nl2br($content) ?>
        </div>
        <?php endif; ?>
        ...
        <?php 
        $programs_meta = getSectionMeta($sections, 'programs_offered');
        if ($programs_meta && isset($programs_meta['programs']) && count($programs_meta['programs']) > 0):
        ?>
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    <?php foreach ($programs_meta['programs'] as $program): ?>
                    <tr>
        ...
        <?php endif; ?>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        $chairperson_query = dbPrepare("SELECT * FROM TESDA_faculty WHERE is_chairperson = 1 AND is_active = 1 LIMIT 1");
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="contact-form" method="POST">
                    <input type="hidden" name="department" value="TESDA">
                    <div class="row">
                        <div class="col-md-6">
